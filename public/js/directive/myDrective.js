 ...
 * @Last Modified time: 2016-06-06 17:51:18
 */
...
// 带树形结构时的tree指令
    // .directive('myTree', function() {
    //     return {
    //         restrict: 'AE',
    //         templateUrl: '../template/directive/treeView.html',
    ...
    //     return {
    //         restrict: 'AE',
    //         templateUrl: '../template/directive/treeView1.html',
    //         controller: ['$scope', function($scope) {
    //             $scope.itemExpended = function(item, $event) {
    //                 console.log(item);
    //                 item.$$isExpend = !item.$$isExpend;
    ...
    .directive('myTree',function(){
      return {
          restrict: 'AE',
          templateUrl:'../template/directive/tree.html'
      }
    })
